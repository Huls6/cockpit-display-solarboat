...
const uint8_t* getLetterBitmap(const char letter, size_t* size) {
    ...
    static uint8_t F[] = { 0x7F, 0x09, 0x09, 0x09, 0x01, 0x00 };
    static uint8_t G[] = { 0x3E, 0x41, 0x49, 0x49, 0x3A, 0x00 };
    static uint8_t H[] = { 0x7F, 0x08, 0x08, 0x08, 0x7F, 0x00 };
    static uint8_t I[] = { 0x00, 0x41, 0x7F, 0x41, 0x00, 0x00 };
    static uint8_t J[] = { 0x20, 0x40, 0x40, 0x40, 0x3F, 0x00 };
    static uint8_t K[] = { 0x7F, 0x08, 0x14, 0x22, 0x41, 0x00 };
    static uint8_t L[] = { 0x7F, 0x40, 0x40, 0x40, 0x40, 0x00 };
    static uint8_t M[] = { 0x7F, 0x02, 0x04, 0x02, 0x7F, 0x00 };
    static uint8_t N[] = { 0x7F, 0x02, 0x4, 0x08, 0x7F, 0x00 };
    static uint8_t O[] = { 0x3E, 0x41, 0x41, 0x41, 0x3E, 0x00 };
    static uint8_t P[] = { 0x7F, 0x09, 0x09, 0x09, 0x06, 0x00 };
    static uint8_t Q[] = { 0x3E, 0x41, 0x41, 0x21, 0x7E, 0x00 };
    static uint8_t R[] = { 0x7F, 0x09, 0x19, 0x29, 0x46, 0x00 };
    static uint8_t S[] = { 0x46, 0x49, 0x49, 0x49, 0x31, 0x00 };
    static uint8_t T[] = { 0x01, 0x01, 0x7F, 0x01, 0x01, 0x00 };
    static uint8_t U[] = { 0x3F, 0x40, 0x40, 0x40, 0x3F, 0x00 };
    static uint8_t V[] = { 0x1F, 0x20, 0x40, 0x20, 0x1F, 0x00 };
    static uint8_t W[] = { 0x7F, 0x40, 0x3C, 0x40, 0x7F, 0x00 };
    static uint8_t X[] = { 0x63, 0x14, 0x08, 0x14, 0x63, 0x00 };
    static uint8_t Y[] = { 0x03, 0x0C, 0x70, 0x0C, 0x03, 0x00 };
    ...
    static const uint8_t slash[] = {0x60,0x30,0x18,0x0C,0x06,0x00};
    ...
    switch (letter) {
        ...
        case '/': *size = sizeof(slash); return slash;
...
const uint8_t* getLargeNumberBod(const char Lnumb, size_t* size) {
    static const uint8_t L0[] = { 0x3F, 0x7F, 0xE0, 0xC0, 0xC1, 0xC7, 0xDE, 0xF8, 0x7F, 0x3F ,0x00 };
    static const uint8_t L1[] = { 0x00, 0xC0, 0xC0, 0xFF, 0xFF, 0xC0, 0xC0, 0x00, 0x00 };
    static const uint8_t L2[] = { 0xF0, 0xF8, 0xDC, 0xCE, 0xC7, 0xC3, 0xC3, 0xC3, 0xC1, 0xC0, 0x00 };
    static const uint8_t L3[] = { 0x30, 0x70, 0xE0, 0xC0, 0xC1, 0xC1, 0xC1, 0xE3, 0x7F, 0x3E, 0x00 };
    static const uint8_t L4[] = { 0x0F, 0x0F, 0x0C, 0x0C, 0x0C, 0x0C, 0xFF, 0xFF, 0x0C, 0x0C, 0x00 };
    static const uint8_t L5[] = { 0x30, 0x70, 0xE0, 0xC0, 0xC0, 0xC0, 0xC0, 0xE1, 0x7F, 0x3F, 0x00 };
    static const uint8_t L6[] = { 0x3F, 0x7F, 0xE7, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xE7, 0x7E, 0x3C };
    static const uint8_t L7[] = { 0x00, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    static const uint8_t L8[] = { 0x3E, 0x7F, 0xE3, 0xC1, 0xC1, 0xC1, 0xC1, 0xE3, 0x7F, 0x3E, 0x00 };
    static const uint8_t L9[] = { 0x30, 0x70, 0xE1, 0xC1, 0xC1, 0xC1, 0xC1, 0xE1, 0x7F, 0x3F, 0x00 };
    static const uint8_t Lmin[] = { 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00 };
    static const uint8_t Ldot[] = { 0x00, 0xC0, 0xC0, 0x00 };
    static const uint8_t defaultLN[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

    switch (Lnumb) {
        case '0': *size = sizeof(L0); return L0;
        case '1': *size = sizeof(L1); return L1;
        case '2': *size = sizeof(L2); return L2;
        case '3': *size = sizeof(L3); return L3;
        case '4': *size = sizeof(L4); return L4;
        case '5': *size = sizeof(L5); return L5;
        case '6': *size = sizeof(L6); return L6;
        case '7': *size = sizeof(L7); return L7;
        case '8': *size = sizeof(L8); return L8;
        case '9': *size = sizeof(L9); return L9;
        case '-': *size = sizeof(Lmin); return Lmin;
        case '.': *size = sizeof(Ldot); return Ldot;
        default: *size = sizeof(defaultLN); return defaultLN;   // Default
    }
}

// large Number bitmap
const uint8_t* getLargeNumberTop(const char Lnumb, size_t* size) {
    static const uint8_t L0[] = { 0xFC, 0xFE, 0x1F, 0x7B, 0xE3, 0x83, 0x03, 0x07, 0xFE, 0xFC ,0x00 };
    static const uint8_t L1[] = { 0x00, 0x0C, 0x0E, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00 };
    static const uint8_t L2[] = { 0x0C, 0x0E, 0x07, 0x03, 0x03, 0x03, 0x03, 0x87, 0xFE, 0xFC, 0x00 };
    static const uint8_t L3[] = { 0x0C, 0x0E, 0x07, 0x03, 0x83, 0x83, 0x83, 0xC7, 0xFE, 0x7C, 0x00 };
    static const uint8_t L4[] = { 0xC0, 0xE0, 0x70, 0x38, 0x1C, 0x0E, 0xFF, 0xFF, 0x00, 0x00, 0x00 };
    static const uint8_t L5[] = { 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x83, 0x03, 0x00 };
    static const uint8_t L6[] = { 0xFC, 0xFE, 0x87, 0x03, 0x03, 0x03, 0x03, 0x07, 0x0E, 0x0C, 0x00 };
    static const uint8_t L7[] = { 0x03, 0x03, 0x03, 0x83, 0xC3, 0xE3, 0x73, 0x3B, 0x1F, 0x0F, 0x00 };
    static const uint8_t L8[] = { 0x7C, 0xFE, 0xC7, 0x83, 0x83, 0x83, 0x83, 0xC7, 0xFE, 0x7C, 0x00 };
    static const uint8_t L9[] = { 0x7C, 0xFE, 0xC7, 0x83, 0x83, 0x83, 0x83, 0x87, 0xFE, 0xFC, 0x00 };
    static const uint8_t Lmin[] = { 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00 };
    static const uint8_t Ldot[] = { 0x00, 0x00, 0x00, 0x00 };
    static const uint8_t defaultLN[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
